...
ThisBuild / crossScalaVersions := Seq(Scala212, "2.13.4", "3.0.0-RC1", "3.0.0-RC2")
...
val testSettings = Seq(
  ...
  libraryDependencies += ("org.typelevel" %% "cats-kernel" % "2.4.2").withDottyCompat(scalaVersion.value)
)
